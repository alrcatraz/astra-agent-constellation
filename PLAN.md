...
> 0.1.0 已发布（gitea 私有，v0.1.0，2026-08-04）；**v0.2.0（2026-08-14，ACP 化 + dsh 执行者版）**；**v0.2.1（2026-08-15，dsh 替换 OpenCode 落地 + 执行者 key 按机隔离）**；正式版 v1.0.0 待 AIGate 开发完成 + 实际部署验证后再出。
